...
class FormUpdateDatalatih extends CI_Controller {
    ...
    public function index($id = null) {
        ...
        $data['u'] = $this->M_datalatih->get_datalatih_by_id($id);

        if (!$data['u']) {
            show_404();
        }

        $data['title'] = "Update Data Latih";
        $data['isi'] = 'admin/formUpdate_datalatih';
